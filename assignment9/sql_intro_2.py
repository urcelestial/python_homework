...
# Connect to the database and read data into a DataFrame using SQL JOIN
...
# Add 'total' column (quantity * price) and print first 5 lines
...
# Write the final DataFrame to order_summary.csv in assignment9
summary_df.to_csv("assignment9/order_summary.csv", index=False)
